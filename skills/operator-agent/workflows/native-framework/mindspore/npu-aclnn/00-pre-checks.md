...
Path convention: unless stated otherwise, inspect the local MindSpore repository and local ACLNN documentation in the active workspace. The imported workflow gives the sequence; the repository remains the source of truth.
...
4. **Choose the integration path (core decision)**
...
5. **Produce a PTA difference record**: use `templates/aclnn/pta-analysis-report.md` and generate a file such as `{op_name}_pta_analysis.md`
...
1. Copy `templates/aclnn/feature-document.md` and name it `{operator_name}_Feature.md`
2. Fill the following sections based on the Pre-B analysis results:
   - [1. Background](../../../../templates/aclnn/feature-document.md#feature-background)
   - [2. Benchmark And APIs](../../../../templates/aclnn/feature-document.md#feature-benchmark-api)
   - [3. Task List](../../../../templates/aclnn/feature-document.md#feature-task-list) (initialize the standard 13-category table)
   - [4. Functional And API Specification](../../../../templates/aclnn/feature-document.md#feature-functional-spec) (interface signature and parameter descriptions)
   - [6. Constraints And Types](../../../../templates/aclnn/feature-document.md#feature-constraints) (device, dtype, and shape constraints)
   - [8. Differences From PTA And Alignment Status](../../../../templates/aclnn/feature-document.md#feature-pta-alignment) (initial version)
...
3. **Produce the coverage inventory** using `templates/aclnn/aclnn-callchain-analysis.md`
...
1. ✅ PTA source review report (output of Pre-B, using `templates/aclnn/pta-analysis-report.md`)
